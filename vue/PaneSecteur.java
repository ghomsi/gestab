...
public class PaneSecteur {
    ...
    public PaneSecteur(DAOequipement dao,Equipement EQ){
        this.secteur = new Secteur(EQ.getNom());
        this.secteur.setNbEq(EQ.getTmpNbEq());
        this.secteur.setNbCarte(EQ.getTmpNbCarte());
        this.secteur.setNbPort(EQ.getTmpNbPort());
        this.secteur.setNbPortLibre(EQ.getTmpNbPortLibre());
        this.secteur.setNbPortOccupe(EQ.getTmpNbPortOccupe());
        this.secteur.setNbPortDefect(EQ.getTmpNbPortDefect());
        this.dao = dao;
        this.chart = null;
    }
    ...
    public FlowPane construire(){
        ...
        deletebtn.getStyleClass().add("buttonAdminEq");
       
        
        Button modifbtn = new Button (" Modifier ");
        modifbtn.getStyleClass().add("buttonAdminEq");
