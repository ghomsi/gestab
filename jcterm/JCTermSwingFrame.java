...
public class JCTermSwingFrame extends JFrame
  ...
  static String COPYRIGHT="GESTerm is based on JCTerm 0.0.11\nCopyright (C) camtel 2016.\n";
  ...
  public JCTermSwingFrame(String name, String configName){
    ...
    addWindowListener(new WindowAdapter(){
      public void windowClosing(WindowEvent e){
        //System.exit(0);
        new Notifier("GESTAB!", "Gesterm fermé!",2);
      }
    });
  ...
  public void run(){
    ...
    while(thread!=null){
      try{
        ...
        new Notifier("GESTAB!", user+"@"+host+" Connection établie",2);
    ...
    new Notifier("GESTAB!", user+"@"+host+" Deconnecté",2);
    frame.setTitle("GESTerm");
    thread=null;
  ...
  public void openFrame(int _mode, String configName){
    JCTermSwingFrame c = new JCTermSwingFrame("GESTerm", configName);
    c.mode=_mode;
